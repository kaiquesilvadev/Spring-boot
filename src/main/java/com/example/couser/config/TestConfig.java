package com.example.couser.config;
...
import com.example.couser.entities.Payment;
...
import com.example.couser.repositories.OrderItemRepository;
...
public class TestConfig {
	...
	public void run(String... args) throws Exception {
		/* essa configuração vai preencher o banco de dados H2 */

		/*
		 * user o http://localhost:8080/h2-console/login.do?jsessionid=
		 * 8197f6cc9dc8c0f3a14806a878bad7db
		 */
